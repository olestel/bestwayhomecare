          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="blog-details blog-details-docs shadow-three dark:bg-gray-dark rounded-sm bg-white px-8 py-11 sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                <h1>Privacy Policy for Best Way Home Care</h1>
                ...
                <div className="tab-content translations-content-item en visible" id="en">
                  ...
                  <ul className="list-disc">
                    ...
                    <li>
                      <b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Best Way Home Care, Inc, 3501 W Algonquin rd, Suit 210-G, Rolling MEadows, IL, 60008.
                    </li>
                    <li>
