type AreaData = {
  activeArea: number;
  id: number;
  handleAreaToggle: (id: number) => void;
  quest: string;
  ans: string;
};

const AreaItem = ({ areaData }: { areaData: AreaData }) => {
  const { activeArea, id, handleAreaToggle, quest, ans } = areaData;
